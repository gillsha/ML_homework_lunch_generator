...
import { chromium } from '/var/folders/z_/1wgnkc556gg6ny5x122wt4z40000gn/T/opencode/lunch-generator-check/node_modules/playwright/index.mjs';

const root = '/var/folders/z_/1wgnkc556gg6ny5x122wt4z40000gn/T/opencode/week1-prompt-first-pass-20260919';
const url = `file://${root}/week1/index.html`;
const expected = [
